...
Os comentários do código e o guia de integração estão em português; a spec da API e
o [README em inglês](README.md) atendem quem integra de fora. Públicos diferentes.
